...
@property(copy, nonatomic, readonly) DistantHessianReqBlock reqBlock;
/*!
 ...
 * @seealso 
 */
+(CWDistantHessianObject*)proxyWithURL:(NSURL*)URL;

+(CWDistantHessianObject*)proxyWithURL:(NSURL*)URL
                              reqBlock:(DistantHessianReqBlock)reqData;
 ...
 */
-(CWDistantHessianObject*)proxyWithURL:(NSURL*)URL
                              reqBlock:(DistantHessianReqBlock)block;
